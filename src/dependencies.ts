...
export const getProjectDeps = (firstRunResults: Array<AnalyzedEntity>): Array<string> => {
...
export const getTimesDependedOn = (projectDeps: Array<string>, filePath: string): number => {
